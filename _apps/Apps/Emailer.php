...

{
	...
	public $fromEmail = "admin@greenfieldexedu.com";

	public $fromName = "Greenfield Executive Education";

	public $replyEmail = "admin@greenfieldexedu.com";

	public $replyName = "Greenfield Executive Education";
